...
#define WS_DISSECTOR_VERSION "4.4.9"
...
void try_dissect(epan_t *session, size_t data_len, const guchar* raw_data)
{
    ...
    write_pdml_proto_tree(NULL, edt, edt->pi.cinfo, stdout, FALSE); 
...
{
    printf("ws_dissector Android stub version\n");
    printf("This is a minimal Android build for testing purposes.\n");
    printf("Full functionality requires Wireshark libraries to be cross-compiled.\n");
    return 0;
}
#else
int main(int argc, char** argv)
